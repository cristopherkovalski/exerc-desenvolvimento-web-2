<%-- 
    Document   : atendimentoVisualizar
    Created on : 30 de jan. de 2023, 14:08:44
    Author     : 
--%>
...
<html>
    <head>
        ...
        <title>atendimentoVisualizar</title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <tr><th>Codigo Atendimento</th><th>Tipo Atendimento</th><th>Situação</th><th style="text-align:center">Visualizar</th>
                    <jsp items="${requestScope.listaatd}" var="atendimento" >
                        <tr><td>${atendimento.idatendimento}</td>
                            <td>${atendimento.tipoatendimento.nometipoatendimento}</td>
                            <td>${atendimento.resolvido}</td>
                            <td align="center">
                                <a class="btn btn-success btn-circle btn-sm" href="AtendimentoServlet?action=show&id=${atendimento.id}" role="button">
